package com.example.nurecareercenterua.jwt.provider;
...
import static com.example.nurecareercenterua.jwt.constants.JwtSecurityConstant.*;
...
public class JwtTokenProvider {
    ...
    public HttpHeaders generateJwtHeader(AccountDto account) {
        ...
        headers.add(JwtSecurityConstant.JWT_TOKEN_HEADER_NAME, jwt);
